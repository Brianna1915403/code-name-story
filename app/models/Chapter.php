<?php
    ...
    class Chapter extends \App\core\Model {
        ...
        public function insert(){
            $stmt = self::$connection->prepare("INSERT INTO chapter(story_id, chapter_title, chapter_text, date_created, likes, chapter_picture_id) VALUES (:story_id, :chapter_text, :date_created, :likes)");
            $stmt->execute(["story_id"=>$this->story_id, "chapter_title"=>$this->chapter_title,"chapter_text"=>$this->chapter_text, "date_created"=>$this->date_created, "likes"=>$this->likes]);
        }
